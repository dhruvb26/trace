    ...
    return (
      ...
      >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <CurrentLogo className="w-20 h-20  max-w-[80%] max-h-[80%] object-contain" />
          </motion.div>
        </AnimatePresence>
      </motion.div>
    )
...
function LogoCarousel({ columnCount = 2 }: { columnCount?: number }) {
  ...
  const allLogos: Logo[] = useMemo(
    () => [
      { name: 'Meta', id: 1, img: MetaIcon },
      { name: 'Shopify', id: 2, img: ShopifyIcon },
      { name: 'Amazon', id: 3, img: AmazonIcon },
      { name: 'Squarespace', id: 4, img: SquarespaceIcon },
    ],
    []
  )
...
function MetaIcon() {
  return <Image src="/logos/meta.svg" alt="Meta" width={95} height={95} />
}

function ShopifyIcon() {
  return <Image src="/logos/shopify.svg" alt="Shopify" width={80} height={80} />
}

function AmazonIcon() {
  return <Image src="/logos/amazon.svg" alt="Amazon" width={105} height={105} />
}
